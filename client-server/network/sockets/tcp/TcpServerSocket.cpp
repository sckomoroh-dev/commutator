...
void TcpServerSocket::bind()
{
    ...
    {
        throw SocketException("Unable to bind server socket", platform_socket_error());
    }
}
...
void TcpServerSocket::listen() const
{
    ...
    {
        throw SocketException("Unable to start listen", platform_socket_error());
    }
}
...
std::unique_ptr<TcpClientSocket> TcpServerSocket::accept()
{
    ...
    {
        throw SocketException("Unable to accept client socket", platform_socket_error());
    }
